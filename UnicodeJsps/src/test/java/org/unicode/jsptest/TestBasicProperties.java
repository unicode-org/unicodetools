...
public class TestBasicProperties extends TestFmwk2 {
    ...
    public void TestListing() {
        for (Entry<String, PropertyMetaDatum> propInfo :
                PropertyMetadata.getPropertyToData().entrySet()) {
            if (isVerbose()) {
    ...
    //                Set<String> propsMissingMetadata = new
    // LinkedHashSet<String>(cp.getPropertyNames());
