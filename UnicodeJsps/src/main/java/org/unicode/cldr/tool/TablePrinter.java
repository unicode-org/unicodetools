...
public class TablePrinter {
    ...
    private static class Column {
        ...
        public Column setCellAttributes(String cellAttributes) {
            this.cellAttributes =
                    new MessageFormat(MessageFormat.autoQuoteApostrophe(cellAttributes));
            return this;
        }
        ...
        public Column setCellPattern(String cellPattern) {
            this.cellPattern =
                    cellPattern == null
                            ? null
                            : new MessageFormat(MessageFormat.autoQuoteApostrophe(cellPattern));
            return this;
        }
    ...
    public String toTableInternal(Comparable[][] sortedFlat) {
        ...
        for (int i = 0; i < sortedFlat.length; ++i) {
            ...
            if (i != 0) {
                ...
                if (divider) {
                    result.append(
                            "\t<tr><td class='divider' colspan='" + visibleWidth + "'></td></tr>");
                }
            }
            result.append("\t<tr>");
            for (int j = 0; j < sortedFlat[i].length; ++j) {
