...
public class PropertyMetadata {
    ...
    private static class MyHandler extends FileUtilities.SemiFileReader {
        ...
        private Set<Row.R4<String, String, String, String>> set =
                new TreeSet<Row.R4<String, String, String, String>>();
        private Map<String, PropertyMetaDatum> _propToDatum =
                new TreeMap<String, PropertyMetaDatum>();
        ...
        public boolean handleLine(int start, int end, String[] items) {
            if (items.length != 4) {
                throw new IllegalArgumentException(
                        "Must have exactly 4 items: " + Arrays.asList(items));
            }
            ...
            set.add(
                    (R4<String, String, String, String>)
                            Row.of(items[3], items[2], items[1], items[0]).freeze());
            set.add(
                    (R4<String, String, String, String>)
                            Row.of(items[3], items[2], items[1], items[0] + "β").freeze());
            return true;
        }
