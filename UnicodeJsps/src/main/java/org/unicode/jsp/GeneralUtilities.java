...
public class GeneralUtilities {
    ...
    /**
     * Used to set a static debug flag from an environment variable. Allows static final flags to be
     * set for debugging information even in environments where the source cannot be altered. For a
     * given class StringPrepData, the debug flag is -Dstringprepdata_<flagname> (that is, all
     * lowercase).
     *
     * <p>Example:
     *
