...
public final class Navigator {
    ...
    private static class Tester {
        ...
        Tester(double latitude1, double longitude1) {
            ...
            System.out.println(
                    "\tLatitude1 " + degrees(a.getLat1()) + "\tLongitude1 " + degrees(a.getLon1()));
        }
    ...
    public static double toRadians(
            double degrees, double minutes, double seconds, boolean northOrWest) {
    ...
    public Navigator setLat2Lon2(double lat2, double lon2) {
        ...
        distance =
                2
                        * Math.asin(
                                Math.sqrt(
                                        halfLatDiff * halfLatDiff
                                                + cosLat1 * cosLat2 * halfLonDiff * halfLonDiff));
