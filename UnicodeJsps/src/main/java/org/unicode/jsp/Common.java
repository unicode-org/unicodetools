...
public class Common {
    static final Normalizer2 NFKC_CF_ = Normalizer2.getInstance(null, "nfkc_cf", Normalizer2.Mode.COMPOSE);
    ...
    public static Transform<String,String> NFKC_CF = new StringTransform() {
        public String transform(String source) {
    ...
    public static HanTypeValues getValue(int codepoint) {
        if (Common.simpOnly.contains(codepoint))
            return HanTypeValues.Hans;
        if (Common.tradOnly.contains(codepoint))
            return HanTypeValues.Hant;
        if (Common.bothSimpTrad.contains(codepoint))
            return HanTypeValues.Han;
