...
public class ScriptCategoriesCopy {
    ...
    public static final UnicodeSet IPA_EXTENSIONS =
            new UnicodeSet("[ɩɷɼɿʅ-ʇʓʖʗʚʞʠʣʥʦʨ-ʯ]").freeze();
    ...
    public static final UnicodeSet EUROPEAN =
            new UnicodeSet(
                            "[[:script=Latin:][:script=Greek:][:script=Coptic:][:script=Cyrillic:]"
                                    ...
                                    + "[:script=old italic:]]")
                    .freeze();
    public static final UnicodeSet MIDDLE_EASTERN =
            new UnicodeSet(
                    ...
                    .freeze();
    public static final UnicodeSet SOUTH_ASIAN =
            new UnicodeSet(
                    ...
                    .freeze();
    public static final UnicodeSet SOUTHEAST_ASIAN =
            new UnicodeSet(
                    ...
                    .freeze();
    public static final UnicodeSet EAST_ASIAN =
            new UnicodeSet(
                            "[[:script=Bopomofo:][:script=Hiragana:][:script=Katakana:][:script=Mongolian:]"
                                    + "[:script=Yi:]]")
                    .freeze();
    public static final UnicodeSet AFRICAN =
            new UnicodeSet(
                            "[[:script=Ethiopic:][:script=Osmanya:][:script=Tifinagh:]"
                                    + "[:script=Nko:][:script=vai:]]")
                    .freeze();
    public static final UnicodeSet AMERICAN =
            new UnicodeSet("[[:script=Cherokee:][:script=CANS:][:script=Deseret:]]").freeze();
    public static final UnicodeSet OTHER_SCRIPTS =
