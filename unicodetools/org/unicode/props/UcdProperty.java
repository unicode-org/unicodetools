...
public enum UcdProperty {
    ...
    Bidi_Paired_Bracket(PropertyNames.PropertyType.Miscellaneous, "bpb"),
    CJK_Radical(PropertyNames.PropertyType.Miscellaneous, "CJKR"),
    Confusable_MA(PropertyNames.PropertyType.Miscellaneous, "ConfMA"),
    Confusable_ML(PropertyNames.PropertyType.Miscellaneous, "ConfML"),
    Confusable_SA(PropertyNames.PropertyType.Miscellaneous, "ConfSA"),
    Confusable_SL(PropertyNames.PropertyType.Miscellaneous, "ConfSL"),
    ...
    Id_Mod_Status(PropertyNames.PropertyType.Miscellaneous, "idmods"),
    Id_Mod_Type(PropertyNames.PropertyType.Miscellaneous, "idmodt"),
    Idn_2008(PropertyNames.PropertyType.Miscellaneous, "idn8"),
    Idn_Mapping(PropertyNames.PropertyType.Miscellaneous, "idnm"),
    Idn_Status(PropertyNames.PropertyType.Miscellaneous, "idns"),
    ...
    kZVariant(PropertyNames.PropertyType.Miscellaneous, "cjkZVariant"),
		...
		// Catalog
    Age(PropertyNames.PropertyType.Catalog, UcdPropertyValues.Age_Values.class, "age"),
    Block(PropertyNames.PropertyType.Catalog, UcdPropertyValues.Block_Values.class, "blk"),
    Script(PropertyNames.PropertyType.Catalog, UcdPropertyValues.Script_Values.class, "sc"),

		// Enumerated
    Bidi_Class(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Bidi_Class_Values.class, "bc"),
    Bidi_Paired_Bracket_Type(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Bidi_Paired_Bracket_Type_Values.class, "bpt"),
    Canonical_Combining_Class(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Canonical_Combining_Class_Values.class, "ccc"),
    Decomposition_Type(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Decomposition_Type_Values.class, "dt"),
    East_Asian_Width(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.East_Asian_Width_Values.class, "ea"),
    General_Category(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.General_Category_Values.class, "gc"),
    Grapheme_Cluster_Break(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Grapheme_Cluster_Break_Values.class, "GCB"),
    Hangul_Syllable_Type(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Hangul_Syllable_Type_Values.class, "hst"),
    Indic_Matra_Category(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Indic_Matra_Category_Values.class, "InMC"),
    Indic_Syllabic_Category(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Indic_Syllabic_Category_Values.class, "InSC"),
    Joining_Group(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Joining_Group_Values.class, "jg"),
    Joining_Type(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Joining_Type_Values.class, "jt"),
    Line_Break(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Line_Break_Values.class, "lb"),
    NFC_Quick_Check(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.NFC_Quick_Check_Values.class, "NFC_QC"),
    NFD_Quick_Check(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.NFD_Quick_Check_Values.class, "NFD_QC"),
    NFKC_Quick_Check(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.NFKC_Quick_Check_Values.class, "NFKC_QC"),
    NFKD_Quick_Check(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.NFKD_Quick_Check_Values.class, "NFKD_QC"),
    Numeric_Type(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Numeric_Type_Values.class, "nt"),
    Sentence_Break(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Sentence_Break_Values.class, "SB"),
    Word_Break(PropertyNames.PropertyType.Enumerated, UcdPropertyValues.Word_Break_Values.class, "WB"),

		// Binary
    ASCII_Hex_Digit(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "AHex"),
    Alphabetic(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Alpha"),
    Bidi_Control(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Bidi_C"),
    Bidi_Mirrored(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Bidi_M"),
    Case_Ignorable(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CI"),
    Cased(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Cased"),
    Changes_When_Casefolded(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWCF"),
    Changes_When_Casemapped(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWCM"),
    Changes_When_Lowercased(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWL"),
    Changes_When_NFKC_Casefolded(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWKCF"),
    Changes_When_Titlecased(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWT"),
    Changes_When_Uppercased(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CWU"),
    Composition_Exclusion(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "CE"),
    Dash(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Dash"),
    Default_Ignorable_Code_Point(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "DI"),
    Deprecated(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Dep"),
    Diacritic(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Dia"),
    Expands_On_NFC(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XO_NFC"),
    Expands_On_NFD(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XO_NFD"),
    Expands_On_NFKC(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XO_NFKC"),
    Expands_On_NFKD(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XO_NFKD"),
    Extender(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Ext"),
    Full_Composition_Exclusion(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Comp_Ex"),
    Grapheme_Base(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Gr_Base"),
    Grapheme_Extend(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Gr_Ext"),
    Grapheme_Link(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Gr_Link"),
    Hex_Digit(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Hex"),
    Hyphen(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Hyphen"),
    IDS_Binary_Operator(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "IDSB"),
    IDS_Trinary_Operator(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "IDST"),
    ID_Continue(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "IDC"),
    ID_Start(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "IDS"),
    Ideographic(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Ideo"),
    Join_Control(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Join_C"),
    Logical_Order_Exception(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "LOE"),
    Lowercase(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Lower"),
    Math(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Math"),
    Noncharacter_Code_Point(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "NChar"),
    Other_Alphabetic(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OAlpha"),
    Other_Default_Ignorable_Code_Point(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "ODI"),
    Other_Grapheme_Extend(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OGr_Ext"),
    Other_ID_Continue(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OIDC"),
    Other_ID_Start(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OIDS"),
    Other_Lowercase(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OLower"),
    Other_Math(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OMath"),
    Other_Uppercase(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "OUpper"),
    Pattern_Syntax(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Pat_Syn"),
    Pattern_White_Space(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Pat_WS"),
    Quotation_Mark(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "QMark"),
    Radical(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Radical"),
    STerm(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "STerm"),
    Soft_Dotted(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "SD"),
    Terminal_Punctuation(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Term"),
    Unified_Ideograph(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "UIdeo"),
    Uppercase(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "Upper"),
    Variation_Selector(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "VS"),
    White_Space(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "WSpace"),
    XID_Continue(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XIDC"),
    XID_Start(PropertyNames.PropertyType.Binary, UcdPropertyValues.Binary.class, "XIDS"),
		;
