...
public enum UcdProperty {
    ...
    Emoji_Label(PropertyType.Miscellaneous, "eLabel"),
    ...
    Emoji_Correspondences(PropertyType.Enumerated, UcdPropertyValues.Emoji_Correspondences_Values.class, "EC"),
    Emoji_Default_Style(PropertyType.Enumerated, UcdPropertyValues.Emoji_Default_Style_Values.class, "EDS"),
    Emoji_Level(PropertyType.Enumerated, UcdPropertyValues.Emoji_Level_Values.class, "EL"),
    Emoji_Modifier_Status(PropertyType.Enumerated, UcdPropertyValues.Emoji_Modifier_Status_Values.class, "EMS"),
    ...
    Identifier_Status(PropertyType.Enumerated, UcdPropertyValues.Identifier_Status_Values.class, "idstatus"),
    Identifier_Type(PropertyType.Enumerated, UcdPropertyValues.Identifier_Type_Values.class, "idtype"),
    Indic_Positional_Category(PropertyType.Enumerated, UcdPropertyValues.Indic_Positional_Category_Values.class, "InPC"),
