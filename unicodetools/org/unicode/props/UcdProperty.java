...
public enum UcdProperty {
    ...
    Confusable_MA(PropertyType.String, "ConfMA"),
    ...
    Emoji_Tag_Sequence(PropertyType.Binary, Binary.class, null, "ETS"),
    Emoji_Zwj_Sequence(PropertyType.Binary, Binary.class, null, "EZS"),
