...
public class PropertyValueSets {
    ...
    public static final Set<General_Category_Values> CONTROL = ImmutableSortedSet.copyOf(EnumSet.of(
    ...
    public static final Set<General_Category_Values> LETTER = ImmutableSortedSet.copyOf(EnumSet.of(
    ...
    public static final Set<General_Category_Values> MARK = ImmutableSortedSet.copyOf(EnumSet.of(
            General_Category_Values.Spacing_Mark,
            General_Category_Values.Enclosing_Mark,
            General_Category_Values.Nonspacing_Mark
            ));
    public static final Set<General_Category_Values> NUMBER = ImmutableSortedSet.copyOf(EnumSet.of(
            General_Category_Values.Decimal_Number,
            General_Category_Values.Letter_Number,
            General_Category_Values.Other_Number
            ));
    public static final Set<General_Category_Values> PUNCTUATION = ImmutableSortedSet.copyOf(EnumSet.of(
    ...
    public static final Set<General_Category_Values> SYMBOL = ImmutableSortedSet.copyOf(EnumSet.of(
    ...
    public static final Set<General_Category_Values> SEPARATOR = ImmutableSortedSet.copyOf(EnumSet.of(
