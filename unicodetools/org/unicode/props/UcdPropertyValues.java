...
public class UcdPropertyValues {
	...
	public enum Joining_Group_Values implements Named {
        ...
        Gamal("Gamal"),
        Hah("Hah"),
        Hanifi_Rohingya_A("Hanifi_Rohingya_A"),
        Hanifi_Rohingya_Ba("Hanifi_Rohingya_Ba"),
        Hanifi_Rohingya_Ca("Hanifi_Rohingya_Ca"),
        Hanifi_Rohingya_Da("Hanifi_Rohingya_Da"),
        Hanifi_Rohingya_Dda("Hanifi_Rohingya_Dda"),
        Hanifi_Rohingya_Ga("Hanifi_Rohingya_Ga"),
        Hanifi_Rohingya_Ha("Hanifi_Rohingya_Ha"),
        Hanifi_Rohingya_Ja("Hanifi_Rohingya_Ja"),
        Hanifi_Rohingya_Ka("Hanifi_Rohingya_Ka"),
        Hanifi_Rohingya_Kha("Hanifi_Rohingya_Kha"),
        Hanifi_Rohingya_Kinna_Wa("Hanifi_Rohingya_Kinna_Wa"),
        Hanifi_Rohingya_Kinna_Ya("Hanifi_Rohingya_Kinna_Ya"),
        Hanifi_Rohingya_La("Hanifi_Rohingya_La"),
        Hanifi_Rohingya_Ma("Hanifi_Rohingya_Ma"),
        Hanifi_Rohingya_Na("Hanifi_Rohingya_Na"),
        Hanifi_Rohingya_Nga("Hanifi_Rohingya_Nga"),
        Hanifi_Rohingya_Nya("Hanifi_Rohingya_Nya"),
        Hanifi_Rohingya_Pa("Hanifi_Rohingya_Pa"),
        Hanifi_Rohingya_Ra("Hanifi_Rohingya_Ra"),
        Hanifi_Rohingya_Rra("Hanifi_Rohingya_Rra"),
        Hanifi_Rohingya_Sa("Hanifi_Rohingya_Sa"),
        Hanifi_Rohingya_Sakin("Hanifi_Rohingya_Sakin"),
        Hanifi_Rohingya_Sha("Hanifi_Rohingya_Sha"),
        Hanifi_Rohingya_Ta("Hanifi_Rohingya_Ta"),
        Hanifi_Rohingya_Tta("Hanifi_Rohingya_Tta"),
        Hanifi_Rohingya_Vowel_Sign_A("Hanifi_Rohingya_Vowel_Sign_A"),
        Hanifi_Rohingya_Vowel_Sign_O("Hanifi_Rohingya_Vowel_Sign_O"),
        Hanifi_Rohingya_Vowel_Sign_U("Hanifi_Rohingya_Vowel_Sign_U"),
        Hanifi_Rohingya_Wa("Hanifi_Rohingya_Wa"),
        Hanifi_Rohingya_Ya("Hanifi_Rohingya_Ya"),
        Hanifi_Rohingya_Za("Hanifi_Rohingya_Za"),
        He("He"),
        Heh("Heh"),
        Heh_Goal("Heh_Goal"),
        Heth("Heth"),
        ...
        Semkath("Semkath"),
        Shin("Shin"),
        Sogdian_Aleph("Sogdian_Aleph"),
        Sogdian_Ayin("Sogdian_Ayin"),
        Sogdian_Beth("Sogdian_Beth"),
        Sogdian_Feth("Sogdian_Feth"),
        Sogdian_Gimel("Sogdian_Gimel"),
        Sogdian_He("Sogdian_He"),
        Sogdian_Heth("Sogdian_Heth"),
        Sogdian_Kaph("Sogdian_Kaph"),
        Sogdian_Lamedh("Sogdian_Lamedh"),
        Sogdian_Lesh("Sogdian_Lesh"),
        Sogdian_Mem("Sogdian_Mem"),
        Sogdian_Nun("Sogdian_Nun"),
        ...
        Sogdian_Shin("Sogdian_Shin"),
        Sogdian_Taw("Sogdian_Taw"),
        Sogdian_Ten("Sogdian_Ten"),
        Sogdian_Twenty("Sogdian_Twenty"),
        Sogdian_Waw("Sogdian_Waw"),
        Sogdian_Yodh("Sogdian_Yodh"),
        Sogdian_Zayin("Sogdian_Zayin"),
