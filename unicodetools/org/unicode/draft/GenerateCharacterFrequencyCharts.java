...
public class GenerateCharacterFrequencyCharts {
    ...
    private void run() throws IOException {
        ...
        for (final String language : CharacterFrequency.getLanguagesWithCounter()) {
            ...
            final DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream(UCD_Types.GEN_DIR + "/frequency/" + language + ".txt"));
            final CompressedDataOutput out = new CompressedDataOutput().set(dataOutputStream);
            final PrintWriter html = BagFormatter.openUTF8Writer(UCD_Types.GEN_DIR + "/frequency-html", htmlFilename);
    ...
    private void printIndex(TablePrinter indexTable, String file) throws IOException {
        final PrintWriter index = BagFormatter.openUTF8Writer(UCD_Types.GEN_DIR + "/frequency-html", file);
