...
public class ShowScriptCategories {
    ...
    public static UnicodeMap<Script_Values> SCRIPT = IUP.loadEnum(UcdProperty.Script, Script_Values.class);
...
//        }
        ...
        System.out.println();
        for (String s : new UnicodeSet(VERSION.getSet(Age_Values.V9_0)).retainAll(SCRIPT.getSet(Script_Values.Common))) {
