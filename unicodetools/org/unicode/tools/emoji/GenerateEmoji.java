...
public class GenerateEmoji {
    ...
    enum Style {
        plain, text, emojiLocale, emoji, emojiFont, bestImage, refImage, svg;
    ...
    static public String getImage(Emoji.Source type, String charsForFile, String chars, boolean useDataUrl,
            String extraClasses) {
        if (chars.codePointAt(0) == 0x1f917) {
            int debug = 0;
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (DO_SPECIALS) {
            ...
            print(Emoji.INTERNAL_OUTPUT_DIR, Form.fullForm, "Male Emoji Data", "male-emoji-list.html", male, Skin.withoutSkin);
            final UnicodeSet female = new UnicodeSet("[🙍 🙎  🙅 🙆  💁  🙋  🤦 🤷 💆  💇  👯🤸]");
            print(Emoji.INTERNAL_OUTPUT_DIR, Form.fullForm, "Female Emoji Data", "female-emoji-list.html", female, Skin.withoutSkin);
        ...
        try (PrintWriter out = FileUtilities.openUTF8Writer(
            ...
            for (Entry<String, Set<String>> entry : keyValuesSet) {
                ...
                out.println("<tr><th class='mediumhead'>"
                        + getDoubleLink(TransliteratorUtilities.toHTML.transform(minorGroup)) + "</th></tr>");
                out.println("<tr>");
                all.addAll(values);
    ...
    private static void showLabelLine(PrintWriter outPlain, UnicodeSet subrange, MajorGroup majorGroup,
        ...
        outPlain.println(stringValue + " ;\t" + majorGroup.toPlainString().replace(";", "\\u003B") + "\t;\t" + minorGroup.replace(";", "\\u003B"));
    }
    ...
    private static void showDefaultStyle() throws IOException {
        ...
        final String mainMessage = "Should all be colorful & monospace, "
                + "except that those marked with “text+ts” and “text-vs” should be monochrome.";
        out.println(
...
//    };
        ...
        try (PrintWriter out = FileUtilities.openUTF8Writer(chartsDir, outFileName);
            ...
            for (String s : SORTED_ALL_EMOJI_CHARS_SET) {
                ...
                if (!orderingGroup.equals(lastOrderingGroup)) {
                    out.println(smallHead + getDoubleLink(TransliteratorUtilities.toHTML.transform(orderingGroup))
                    + "</th></tr>");
    ...
    public static void writeHeader(String outFileName, PrintWriter out, String title, String styles,
        ...
        String headerLine = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">\n"
                ...
                + " | <a target='doc' href='" + tr51Url + "'>Spec</a>\n"
    ...
    public static String getCell(Emoji.Source type, String core, String cellClass, boolean addLink,
        ...
        if (filename != null) {
            ...
            if (fullName == null && Emoji.IS_BETA && type == Source.ref) {
                ...
                fullName = EmojiImageData.getDataUrlFromFilename(type, fullName);
            }
            if (fullName != null) {
    ...
    private static String getSamples(String source) {
        ...
        for (Source item : Source.PLATFORM_FALLBACK) {
            list.add(getImage(item, source, source, true, ""));
        }
