...
public class CollatorEquivalences {
  ...
  static final UnicodeSet LETTER = new UnicodeSet("[:L:]");
  ...
  static {
    ...
    Comparator<String> LONGER_FIRST = new Comparator<String>() {
      ...
      public int compare(String o1, String o2) {
        return o2.codePointCount(0, o2.length()) - o1.codePointCount(0, o1.length());
      }
    };
    ...
    BEST_IS_LEAST = new MultiComparator<String>(LONGER_FIRST, (Comparator<String>)(Comparator<?>) temp2, REGULAR_FIRST, CODEPOINT);
  }

  static void showCollationEquivalences() {
    Relation<RawKey, String> equiv = Relation.of(new TreeMap<RawKey, Set<String>>(), TreeSet.class, BEST_IS_LEAST);
