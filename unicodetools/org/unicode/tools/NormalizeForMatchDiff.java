...
public class NormalizeForMatchDiff {
    public static void main(String[] args) {
        NormalizeForMatch production = NormalizeForMatch.load(
                "/Users/markdavis/Google Drive/workspace/Generated/n4m-old/","xnfkccf_curated.txt");
        ...
        UnicodeSet keys = new UnicodeSet()
