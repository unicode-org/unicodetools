...
public class ScriptPopulation {
  ...
  public static void main(String[] args) {
    ...
    int count = 0;
    System.out.println("№\tlog(%)\tScript (*Cat)\tScript Status\t1st\t2nd\t3rd\t4th\t5th\t6th\t7th\t8th\t9th\t10th\t11th\t12th\t13th\t14th\t15th\t16th\t17th\t18th\t19th\t20th\t…");
    for (Integer category : scriptFrequency.getKeysetSortedByCount(false, null)) {
      Double frequ = scriptFrequency.getCount(category);
      System.out.print(++count
          + (true ? "\t" + nf.format(Math.log(frequ/totalFreq)) : "")
