...
public class GenerateConfusablesCopy {
    ...
    private static final Transliterator EXCAPE_FUNNY = Transliterator.createFromRules(
    ...
    private static class MyEquivalenceClass extends XEquivalenceClass<String,String> {
                ...
                while (true) {
                    ...
                    if (!mapItems.isEmpty()) {
                        ...
                        for (Entry<R2<String, String>, String> entry : mapItems.entrySet()) {
                            addCheck(entry.getKey().get0(), entry.getKey().get1(), entry.getValue() + reason);
                        }
                        mapItems.clear();
                        continue main;
                    }
        ...
        private Map<String, String> mapString(String item, Set<String> alreadyIn) {
            ...
            for (int i = 0; i < item.length(); i += UTF16.getCharCount(cp)) {
                ...
                // swap the results, so that combinations always contains the current values, and newCombinations is always empty
        ...
        public String getParadigm(String item, boolean onlyLowercase, boolean onlySameScript) {
            ...
            //            }
            return CollectionUtilities.getBest(filteredSet, onlyLowercase || onlySameScript ? betterTargetIsLessFavorNeutral : betterTargetIsLess, -1);
        }
