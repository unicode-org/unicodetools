...
public class ShowScripts {
    public static void main(String[] args) {
        ...
        for (Script_Values scriptValue : scriptCounter.getKeysetSortedByCount(false)) {
            ...
            Object popStr = (type == type.Extinct || type == type.Ancient || type == type.Historical) ? "n/a" 
...
//        }
    ...
    private static String name(IdUsage idUsage) {
        switch(idUsage) {
        default:
        case ASPIRATIONAL: throw new IllegalArgumentException();
        case EXCLUSION: return "very limited use";
        case LIMITED_USE: return "limited use";
        case UNKNOWN: 
        case RECOMMENDED: return "common use";
        }
    }

    private static void oldCount(UnicodeMap<Script_Values> script, UnicodeMap<Age_Values> age,
            UnicodeMap<General_Category_Values> gc, Counter<Script_Values> scriptCounter) {
