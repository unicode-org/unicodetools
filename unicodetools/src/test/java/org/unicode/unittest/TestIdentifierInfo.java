...
public class TestIdentifierInfo extends TestFmwkMinusMinus {
    ...
    static final UnicodeSet SpecialExclusions2 =
            new UnicodeSet("[\\U00011301\\U00011303\\U0001133C]");
    ...
    public void testUax31Overlap() {
        ...
        Set<Identifier_Type_Values> notRec =
                ImmutableSet.of(
    ...
    private Identifier_Type_Values getValues(Set<Script_Values> scriptSet) {
        ...
        for (Script_Values script : scriptSet) {
            if (script == Script_Values.Unknown
                    || script == Script_Values.Inherited
                    || script == Script_Values.Common) {
                continue;
            }
