...
public class TestLocaleValidity extends TestFmwkMinusMinus {
    ...
    static final LocaleValidityChecker validityAny =
            new LocaleValidityChecker(EnumSet.allOf(Datasubtype.class));
    static final LocaleValidityChecker validityNoDeprecated =
            new LocaleValidityChecker(
                    EnumSet.of(
                            Datasubtype.macroregion,
                            Datasubtype.private_use,
                            Datasubtype.regular,
                            Datasubtype.special));
    ...
    private void check(String localeString, Validity expectedValidity) {
        ...
        try {
            ...
            //                    + " Syntax error: " + e.getMessage(), expectedValidity,
            // Validity.ill_formed);
            //            return;
        }
