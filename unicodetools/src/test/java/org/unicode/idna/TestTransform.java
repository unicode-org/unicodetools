...
public class TestTransform extends TestFmwkMinusMinus {
    @Test
    @Disabled(
            "Broken - Requested array size exceeds VM limit in org.unicode.idna.FilteredUnicodeTransform.transform(FilteredUnicodeTransform.java:31)    ")
    public void TestBasic() {
        final UnicodeTransform filteredTransform =
                new FilteredUnicodeTransform(
                        UnicodeTransform.getInstance(Type.CASEFOLD), new UnicodeSet("[N-Z]"));
