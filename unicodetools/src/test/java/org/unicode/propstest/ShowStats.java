...
public class ShowStats {
    ...
    private static final UnicodeSet ideo =
            latest.loadEnum(UcdProperty.Ideographic, Binary.class).getSet(Binary.Yes);
    private static final UnicodeMap<Age_Values> ageMap =
            latest.loadEnum(UcdProperty.Age, Age_Values.class);
    private static final UnicodeMap<Script_Values> script =
            latest.loadEnum(UcdProperty.Script, Script_Values.class);
    private static final UnicodeMap<General_Category_Values> cat =
    ...
    // private static final UnicodeMap<String> svsRaw =
    // latest.load(UcdProperty.Standardized_Variant);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 0x10ffff; ++i) {
            ...
            //            if (catGroup == General_Category_Values.Symbol && ageValue ==
            // Age_Values.V7_0) {
            //                System.out.println(block.get(i) + "\tU+" + Utility.hex(i) + "\t" +
            // rawCat + "\t" + name.get(i));
            //            }
        ...
        for (int year = firstYear; year <= lastYear; ++year) {
            ...
            System.out.print(
                    "\t" + (VersionToAge.ucd.getYear(age) == year ? age.getShortName() : ""));
        }
        System.out.print("\n");
    ...
    // private static final LocaleDisplayNames ldn =
