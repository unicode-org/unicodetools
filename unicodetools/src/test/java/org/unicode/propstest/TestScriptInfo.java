...
public class TestScriptInfo extends TestFmwkMinusMinus {
    ...
    public void TestMain() {
        String[][] testCases = {
            // Format is testString, expected scripts, expected alternates, expected numerics (if
            // any)
        ...
        for (String[] testCase : testCases) {
            ...
            //            IdentifierStatus expectedStatus =
            // IdentifierStatus.valueOf(actualStatusString);

            EnumSet<Script_Values> expectedScripts = ScriptInfo.parseScripts(scriptsString);
            Set<EnumSet<Script_Values>> expectedMultiscripts =
                    ScriptInfo.parseAlternates(multiscriptsString);
