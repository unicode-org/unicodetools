...
public class PropertyDemo {
    public static void main(String[] args) {
        ...
        final UnicodeMap<Joining_Group_Values> joiningGroup =
                latest.loadEnum(UcdProperty.Joining_Group, Joining_Group_Values.class);
        final UnicodeMap<Joining_Type_Values> joiningType =
            ...
            for (String s : items) {
                ...
                System.out.println(
                        Utility.hex(cp)
                                ...
                                + latest.getName(cp)
                                + "; "
                                + joiningType.get(cp).getShortName()
                                + "; "
                                + joiningGroup.get(cp).getShortName());
            }
        }
