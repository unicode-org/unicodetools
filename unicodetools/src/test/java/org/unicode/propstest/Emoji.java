...
public class Emoji {
    ...
    static final Set<General_Category_Values> LETTER =
            EnumSet.of(
    ...
    static final Set<General_Category_Values> PUNCTUATION =
            EnumSet.of(
    ...
    static final Set<General_Category_Values> SYMBOL =
            EnumSet.of(
    ...
    private static <E extends Enum<?>> UnicodeSet getSet(
            UnicodeMap<String> source, Set<E> itemSet) {
    ...
    public static void main(String[] args) {
        ...
        final UnicodeMap<Binary> emojiComp =
                latest.loadEnum(UcdProperty.Emoji_Component, Binary.class);
