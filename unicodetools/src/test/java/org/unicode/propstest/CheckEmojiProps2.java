...
public class CheckEmojiProps2 {
    ...
    static UnicodeSet BASIC_EMOJI =
            IUP.loadEnum(UcdProperty.Basic_Emoji, Binary.class).getSet(Binary.Yes);
    static UnicodeSet EMOJI_COMPONENT =
            IUP.loadEnum(UcdProperty.Emoji_Component, Binary.class).getSet(Binary.Yes);
    static UnicodeSet ZWJ_EMOJI =
            IUP.loadEnum(UcdProperty.RGI_Emoji_Zwj_Sequence, Binary.class).getSet(Binary.Yes);
    ...
    public static void main(String[] arg) {
        ...
        System.out.println(
                "new UnicodeSet(EMOJI_COMPONENT).retainAll(BASIC_EMOJI)"
                        + ":\t"
                        + bAndc.toPattern(false));
        System.out.println(
                "new UnicodeSet(EMOJI_COMPONENT).removeAll(BASIC_EMOJI)"
                        + ":\t"
                        + bMinusc.toPattern(false));
    }
}
