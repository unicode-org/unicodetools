...
public class GenerateAnnotationTree {
    ...
    private static UnicodeSetTree<Set<String>> build() {
        Relation<UnicodeSet, String> data2 =
                Relation.of(new HashMap<UnicodeSet, Set<String>>(), HashSet.class);
        ...
        Merger<Set<String>> merger =
                new Merger<Set<String>>() {
                    @Override
