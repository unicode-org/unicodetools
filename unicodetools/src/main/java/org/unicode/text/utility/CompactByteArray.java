 ...
 * ******************************************************************************
 *
 * <p>$Source: /home/cvsroot/unicodetools/org/unicode/text/utility/CompactByteArray.java,v $
 *
 * <p>******************************************************************************
 */
 ...
 * properties, types, keyboard values, etc. only for internal use for now. Made public for
 * discussion purposes.
 *
 * @see CompactIntArray
...
public final class CompactByteArray implements Serializable {
    ...
    public CompactByteArray(short indexArray[], byte newValues[]) throws IllegalArgumentException {
        int i;
