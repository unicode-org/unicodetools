...
public class Settings {
    ...
    // TODO: Why do we sometimes use CldrUtility.getPath() which normalizes paths via
    // java.nio.file.Paths
    ...
    /**
     * Removes one or more trailing ".0" substrings, and/or one trailing "-Update". For quick
     * comparison of version strings and folder names without building VersionInfo objects.
     */
    ...
    private static final int trimmedVersionLength(String version) {
        ...
        while (length >= 2
                && version.charAt(length - 2) == '.'
                && version.charAt(length - 1) == '0') {
            length -= 2;
        }
        return length;
    }
    ...
    public static final class CLDR {
        ...
        public static final String SVN_DIRECTORY =
                CldrUtility.getPath(CldrUtility.getProperty("SVN_DIR", CLDR_REPO_DIR + "/../"));
        public static final String AUX_DIRECTORY =
                CldrUtility.getPath(
                        CldrUtility.getProperty(
                                "CLDR_TMP_DIR", CldrUtility.getPath(SVN_DIRECTORY, "cldr-aux/")));
        public static final String UCD_DATA_DIRECTORY =
                CldrUtility.getPath(SVN_DIRECTORY + "unicodetools/unicodetools/data/");
    ...
    public static final class UnicodeTools {
        /**
         * The root of the unicodetools repo. Contains the UnicodeJsps and unicodetools folders etc.
         */
        ...
        // TODO: IDN_DIR is used, but there is no .../data/IDN/ folder. Should this be
        // .../data/idna/ ?
        ...
        /**
         * Returns a path to the Unicode Tools source data plus the relativeDir and version. Falls
         * back from latestVersion to "dev" as needed. Appends "-Update" to a "ucd" version as
         * needed. Returns null if the folder does not exist.
         */
         ...
         * Falls back from latestVersion to "dev" as needed. Appends "-Update" to a "ucd" version as
         * needed. Returns null if the folder does not exist.
         */
        ...
        /**
         * Returns a path to the Unicode Tools source data plus the relativeDir and latest version.
         * Falls back from latestVersion to "dev" as needed. Appends "-Update" to a "ucd" version as
         * needed. Returns null if the folder does not exist.
         */
        ...
        /**
         * Returns a path string to the Unicode Tools source data plus the relativeDir and latest
         * version. Falls back from latestVersion to "dev" as needed. Appends "-Update" to a "ucd"
         * version as needed. Returns null if the folder does not exist.
         */
        ...
        public enum DataDir {
            ...
            public String versionToString(VersionInfo version) {
                ...
                if (this != EMOJI) {
                    // 13.1, 14.0
                    sb.append(".").append(version.getMilli());
                } // else: 14.0.0
                return sb.toString();
            }
        }
    ...
    public static final class Output {
        ...
        public static final String GEN_DIR = getRequiredPathAndFix("UNICODETOOLS_GEN_DIR");
