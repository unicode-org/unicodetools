 ...
 *
 * <p>The "public static void main" shows an example of this class's usage. The method {@link
 * #getWholeScriptConfusables} is the primary public endpoint.
 *
 * <p>This class uses reflection to access some internal machinery from SpoofChecker, so it is not
 * recommended for use in production-ready code.
 *
 * <p>This script can be run stand-alone by passing a whitespace-separated list of words as the
 * argument list.
 *
 * @author Shane Carr
...
public class GenerateWholeScriptConfusables {
    ...
    static final int MAX_CONFUSABLE_STRING_LENGTH = 18;
     ...
     * @param resultScripts The collection to which to append the sets of scripts corresponding to
     *     the whole script confusables.
     */
    public void getWholeScriptConfusables(
            CharSequence input,
            Collection<String> resultStrings,
        ...
        WholeScriptIterationSet[] scriptsByIndex =
                new WholeScriptIterationSet[skeleton.length() + 1];
    ...
    private static class WholeScriptIterationSet {
        ...
        /**
         * Adds all BitSets that result from intersecting the entries in other1 with other2. If
         * there are N entries in other1, this method will add between 0 and N entries to this
         * instance. For each new entry, records the code point sequence consisting of the previous
         * code point sequence from other1 (if available) and the new codePoint passed to this
         * function. If other1 is null, this method behaves the same as add(other2, "", codePoint).
         *
         * <p>For example, if: other1 = { { A }, { A, B }, { C } } other2 = { B, C }
         *
         * <p>then calling this method will add the following sets: { { B }, { C } }
         */
        public void addIntersectionsOf(
                WholeScriptIterationSet other1, BitSet other2, int codePoint) {
            // Trivial case
            if (other1 == null) {
        ...
        /**
         * Adds the given BitSet to this set if it doesn't already exist. Never keeps a reference to
         * the given BitSet. If the BitSet is added, constructs a new string consisting of the
         * baseString plus the given codePoint, and associates it with the BitSet.
         */
        ...
        /**
         * Identifies entries in this instance that have no overlap with the query, and unions all
         * of those entries into the destination.
         *
         * <p>For example, if this set contained: { { A }, { A, B }, { B, C }, { D } } and query was
         * { A, B } then { D } would be unioned into destination, as D is the only script contained
         * in a BitSet that has an empty intersection with the query.
         *
         * <p>For all entries added to destination, adds an example string to the given Collection.
         */
        public void extractNoOverlap(
                BitSet query, Collection<BitSet> resultScripts, Collection<String> samples) {
            BitSet temp = SpoofCheckerWrapper.ScriptSet_new();
    ...
    /**
     * Data structure used for efficient lookup of confusable skeletons. Each node is associated
     * with an entry from a confusable skeleton. Each node has some set of "transitions" (edges from
     * this node to the next node in a skeleton) and "completions" (edges from this node back to the
     * base node). The "transitions" edges each have a prototype character associated with them, and
     * the "completions" edges each have a codepoint associated with them.
     */
     ...
     *
     * <p>Uses reflection to access private members, meaning that this code might break from an ICU
    ...
    static class SpoofCheckerWrapper {
        ...
        private Object invokeSpoofDataMethod(
                String methodName, Class<?>[] parameterTypes, Object[] parameters) {
            try {
                // Get the method
        ...
        private static Object invokeScriptSetMethod(
                BitSet ss, String methodName, Class<?>[] parameterTypes, Object[] parameters) {
            try {
                // Get the method
        ...
        public static void ScriptSet_appendStringTo(BitSet ss, StringBuilder sb) {
            invokeScriptSetMethod(
                    ss, "appendStringTo", new Class<?>[] {StringBuilder.class}, new Object[] {sb});
        }

        public void getAugmentedScriptSet(int codePoint, BitSet result) {
            invokeMethod(
                    "getAugmentedScriptSet",
                    new Class<?>[] {Integer.TYPE, ScriptSet},
        ...
        public void getResolvedScriptSet(CharSequence input, BitSet result) {
            ...
            invokeMethod(
                    ...
                    new Class<?>[] {CharSequence.class, ScriptSet},
        ...
        class SpoofData {
            ...
            public int codePointAt(int index) {
                return (int)
                        invokeSpoofDataMethod(
                                "codePointAt", new Class<?>[] {Integer.TYPE}, new Object[] {index});
            }

            public void appendValueTo(int index, StringBuilder sb) {
                invokeSpoofDataMethod(
                        "appendValueTo",
                        new Class<?>[] {Integer.TYPE, StringBuilder.class},
                        new Object[] {index, sb});
            }
        }
    }
