 ...
 * ******************************************************************************
 *
 * <p>$Source: /home/cvsroot/unicodetools/org/unicode/text/UCD/UCD_Types.java,v $
 *
 * <p>******************************************************************************
 */
...
public interface UCD_Types {
    ...
    /**
     * Tangut and Tangut Supplement, but not Tangut Components, only assigned code points. The
    ...
    public static final int
            ...
            CJK_C_BASE = 0x2A700,
            CJK_C_LIMIT = 0x2B73A + 1, // last changed in Unicode 17
    ...
    static final byte NOT_DERIVED = 1,
            DERIVED_CORE = 2,
            DERIVED_NORMALIZATION = 4,
            DERIVED_ALL = 0x6,
            ALL = (byte) -1;
    static final byte NUMERIC_PROP = 0,
            STRING_PROP = 1,
            MISC_PROP = 2,
            CATALOG_PROP = 3,
            ENUMERATED_PROP = 4,
    ...
    public static final byte UNASSIGNED = 0,
            ...
            Sk = MODIFIER_SYMBOL,
            So = OTHER_SYMBOL;
    static final int LETTER_MASK = (1 << Lu) | (1 << Ll) | (1 << Lt) | (1 << Lm) | (1 << Lo),
    ...
    public static final byte BidiMirrored = 0,
    ...
    // east asian width
    public static final byte EAN = 0,
            EAA = 1,
            EAH = 2,
            EAW = 3,
            EAF = 4,
    ...
    // bidi class
    static final byte
            BIDI_L = 0, // Left-Right; Most alphabetic, syllabic, and logographic characters (e.g.,
            // CJK ideographs)
    ...
    // numericType
    static final byte NUMERIC_NONE = 0, NUMERIC = 1, DIGIT = 2, DECIMAL = 3, LIMIT_NUMERIC_TYPE = 4;
    //        HAN_PRIMARY = 4, HAN_ACCOUNTING = 5, HAN_OTHER = 6,
    // WARNING, reset to 7 if all properties desired!!

    static final byte NA = 0, L = 1, V = 2, T = 3, LV = 4, LVT = 5, HANGUL_SYLLABLE_TYPE_LIMIT = 6;
    ...
    public static final byte VO_R = 0, VO_TR = 1, VO_TU = 2, VO_U = 3, LIMIT_VO = 4;
