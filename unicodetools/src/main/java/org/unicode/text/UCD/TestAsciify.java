...
public class TestAsciify {
    ...
    /**
     * The following isn't really part of the test; it is a just a snippet with the rules that would
     * be incorporated into the code. Warning: transliterators need to be synchronized if they are
     * shared across threads.
     */
    Transliterator buildTransliterator(String delimiter) {
        // The rule strings are obscured by the need to use only ASCII in source files instead of
        // UTF-8
        final String rules =
                "$delimiter = '"
                        + delimiter
     ...
     * These are not real words, just a sampling that were checked to make sure of the expected
     * values. The Japanese one will need to be changed if a different transliteration is used for
     * that. Note that transliterators may change over time as improvements are made, requiring some
     * changes here. I could do a more comprehensive test if needed.
     */
    static String[][] translitTestCases = {
        ...
        {"\u00C7'\u00EBsht\u00EB", "C-eeshtee"},
        {
            "\u0645\u0647\u064A\u0627\u0644\u0634\u0641\u0631\u0629\u0627\u0644\u0645\u0648\u062D\u062F\u0629\u064A\u0648\u0646\u0650\u0643\u0648\u062F\u061F",
            "mhyalshfrtealmwhdteywnikwd-"
        },
        {"\u4EC0\u9EBD\u662F", "shen-mo-shi"},
        {"\u4EC0\u4E48\u662F", "shen-me-shi"},
        {"\u0160toje", "Stoje"},
    ...
    public void testBasic() {
        final Transliterator asciify = buildTransliterator("-");
        for (final String[] pair : translitTestCases) {
            final String actual = asciify.transform(pair[0]);
