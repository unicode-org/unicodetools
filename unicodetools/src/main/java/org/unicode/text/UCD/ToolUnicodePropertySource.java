...
//		.freeze();
    ...
    addFakeProperty(version, UnicodeProperty.MISC, "<none>", "cjkIRG_SSource", "cjkIRG_SSource", "kIRG_SSource");
    addFakeProperty(version, UnicodeProperty.MISC, "<none>", "cjkIRG_TSource", "cjkIRG_TSource", "kIRG_TSource");
    addFakeProperty(version, UnicodeProperty.MISC, "<none>", "cjkIRG_UKSource", "cjkIRG_UKSource", "kIRG_UKSource");
...
//    addFakeProperty(version, UnicodeProperty.BINARY, "No", "Emoji_Modifier_Base", "EBase");
//    addFakeProperty(version, UnicodeProperty.BINARY, "No", "Emoji_Component", "EComp");
//    addFakeProperty(version, UnicodeProperty.BINARY, "No", "Extended_Pictographic", "ExtPict");
...
U+FF1A ( ： ) FULLWIDTH COLON
	    ...
	    unicodeMap.putAll(new UnicodeSet(lineBreak.getSet("Numeric")).remove(0x066C).add(0xFF10, 0xFF19), "Numeric"); // .remove(0x387)
	...
	if (compositeVersion >= 0x040000) {
	    ...
	    unicodeMap.putAll(getProperty("Whitespace").getSet(UCD_Names.YES)
		    ...
		    , "Sp");
	    final UnicodeSet graphemeExtend = getProperty("Grapheme_Extend").getSet(UCD_Names.YES);
	    unicodeMap.putAll(getProperty("Lowercase")
		    .getSet(UCD_Names.YES)
		    .remove(0x10d0,0x10fa)
		    .remove(0x10FD,0x10FF)
		    .removeAll(graphemeExtend), "Lower");
	    unicodeMap.putAll(getProperty("Uppercase")
		    .getSet(UCD_Names.YES)
		    .remove(0x1C90,0x1CBA)
		    .remove(0x1CBD,0x1CBF)
		    .addAll(cat.getSet("Titlecase_Letter")), "Upper");
	    ...
	    final UnicodeProperty lineBreak = getProperty("Line_Break");
	    unicodeMap.putAll(new UnicodeSet(lineBreak.getSet("Numeric")).add(0xFF10, 0xFF19), "Numeric");
