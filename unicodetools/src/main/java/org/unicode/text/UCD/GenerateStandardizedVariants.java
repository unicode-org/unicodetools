 ...
 * ******************************************************************************
 *
 * <p>$Source: /home/cvsroot/unicodetools/org/unicode/text/UCD/GenerateStandardizedVariants.java,v $
 *
 * <p>******************************************************************************
 */
...
public final class GenerateStandardizedVariants implements UCD_Types {
    ...
    public static void generate() throws IOException {
        ...
        String table =
                "<table><tr><th>Rep Glyph</th><th>Character Sequence</th><th>Context</th><th width='10%'>Alt Glyph</th><th>Description of variant appearance</th></tr>";
        ...
        final BufferedReader in =
                Utility.openUnicodeFile(
                        "StandardizedVariants", Default.ucdVersion(), true, Utility.LATIN1);
        while (true) {
            ...
            table +=
                    "<tr><td><img alt='U+"
                            + codes[0]
                            + "' src='http://www.unicode.org/cgi-bin/"
        ...
        final UnicodeDataFile outfile =
                UnicodeDataFile.openHTMLAndWriteHeader(
                                "UCD/" + version + '/', "StandardizedVariants")
