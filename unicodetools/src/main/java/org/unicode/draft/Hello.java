...
public class Hello {
    ...
    public static void main(String[] args) {
        ...
        for (final String test : new String[] {"en", "ja", "de", "da", "ru"}) {
            for (final TimeUnit timeUnit :
                ...
                for (final int style :
                        new int[] {TimeUnitFormat.ABBREVIATED_NAME, TimeUnitFormat.FULL_NAME}) {
    ...
    private static void checkTranslit() {
        ...
        for (final String rule : rules) {
            ...
            final Transliterator trans =
                    Transliterator.createFromRules("temp", rule, Transliterator.FORWARD);
    ...
    private static void checkCollator(ULocale locale) {
        ...
        System.out.println(
                ".getInstance nanos: " + nf.format((end - start) / (double) iterations) + " ns");
        ...
        System.out.println(
                ".clone nanos: " + nf.format((end - start) / (double) iterations) + " ns");
        ...
        System.out.println(
                ".clone (no try) nanos: " + nf.format((end - start) / (double) iterations) + " ns");
    }
    ...
    //    {return null;}
    //    public final static DateFormat getPatternInstance(Calendar calendar, String pattern,
    // Locale locale)
    //    {return null;}
    //    public final static DateFormat getPatternInstance(Calendar calendar, pattern, ULocale
    // locale)
    //    {return null;}

    public static final String MINUTE_SECOND = "m:ss",
            HOUR_MINUTE = "H:mm",
    ...
    public static final class CurrencyFilter {
        ...
        public static CurrencyFilter onFromDate(Date date) {
            return new CurrencyFilter();
        }

        public static CurrencyFilter onToDate(Date date) {
            return new CurrencyFilter();
        }
        ...
        public CurrencyFilter withFromDate(Date date) {
            return this;
        }

        public CurrencyFilter withToDate(Date date) {
            return this;
        }
    }
}
