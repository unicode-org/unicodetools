...
public class CompareCldrUnihanData {
    ...
    static {
        ...
        UnicodeSet radicals =
                new UnicodeSet(blocks.getSet(Block_Values.CJK_Radicals_Supplement))
    ...
    private static UnicodeMap<String> extractCldrPinyin() {
        ...
        for (String line :
                FileUtilities.in(CLDRPaths.COMMON_DIRECTORY + "/transforms/", "Han-Latin.xml")) {
    ...
    private static <T extends Comparable<T>> UnicodeMap<Pair<T, T>> diff(
            UnicodeMap<T> a, UnicodeMap<T> b) {
