...
public class TestCalendar extends TestFmwk {
    ...
    public void TestDateParsing() throws java.text.ParseException {
        ...
        final com.ibm.icu.util.Calendar newCalendar = com.ibm.icu.util.Calendar.getInstance(gmt, locale);
        final com.ibm.icu.util.Calendar otherCalendar = com.ibm.icu.util.Calendar.getInstance(gmt, locale);
    ...
    public void TestShorterParsing() throws ParseException {
        ...
        final com.ibm.icu.util.TimeZone timeZone = com.ibm.icu.util.TimeZone.getTimeZone(java.util.TimeZone.getDefault().getID());
    ...
    public void TestJavaDateRoundtrip() {
        ...
        for (long millis = future; millis > past; millis -= INCREMENT) { // by just less than a day, back from epoch
            ...
            final Date javaDate2 = new Date(dateYear, dateMonth, dateDayOfMonth, dateHour, dateMinute, dateSecond);
    ...
    public void TestIcuCalenderRoundrip() {
        ...
        final com.ibm.icu.util.Calendar icuCal = com.ibm.icu.util.Calendar.getInstance(icuGMT, icuLocale);
        final com.ibm.icu.util.Calendar icuCal2 = com.ibm.icu.util.Calendar.getInstance(icuGMT, icuLocale);
