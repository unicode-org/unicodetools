...
public class FormatSpecialData2 {
    ...
    public static void main(String[] args) throws IOException {
        String resource =
                FileReaders.getRelativeFileName(FormatSpecialData2.class, "ScriptData.txt");
        ...
        for (RemapType type : RemapType.values()) {
            ...
            PrintWriter out =
                    FileUtilities.openUTF8Writer(
                            CLDRPaths.GEN_DIRECTORY + "special/", specialName + ".txt");
            pivot.clear();
    ...
    private static void addDataToPivot(
            Map<String, UnicodeSet> string2uset, final UnicodeMap<Set<String>> pivot) {
