...
public class BidiConformanceTestBuilder {
    ...
    private static byte[][] extraTests = {
        ...
        {
            AL, L, AL, WS, L, R, L, LRO, WS, AL, L, R, L, R, CS, WS, EN, EN, EN, CS, AN, AN, AN, WS,
            L, R, L, R, PDF
        },
        {
            AL, L, L, WS, RLE, WS, EN, EN, EN, CS, AN, AN, AN, LRO, R, R, AL, RLO, WS, L, L, L, L,
            PDF, WS, L, R, AL, CS
        },
        {AL, ON, FSI, L, PDI, LRI, L, PDI, RLI, R, PDI, ON, ET, EN},
        {AL, R, AL, R, R, AL, WS, ON, EN, EN, ON},
        {
            AL, R, R, R, R, AL, R, WS, AL, R, R, WS, R, AL, AL, R, WS, R, R, R, AL, R, CS, WS, AL,
            EN, EN, EN, CS, EN, EN, AN
        },
        {
            AL, R, WS, AL, R, AL, AL, R, AL, WS, LRE, PDF, WS, EN, EN, EN, ON, EN, EN, AN, WS, R, R,
            AL, AL, WS, R, R, AL, ON
        },
        {
            AL, R, WS, AL, R, AL, AL, R, AL, WS, LRE, WS, PDF, WS, EN, EN, EN, ON, EN, EN, AN, WS,
            R, AL, R, R
        },
        {AL, WS, R, AL, AL, R, WS, AL, R, R, LRE, PDF, WS, AL, R, R, ON},
        {
            AL, WS, R, AL, R, R, WS, AL, R, R, WS, R, AL, AL, R, WS, R, R, R, AL, R, CS, WS, EN, EN,
            EN, ET, CS, EN, EN, AN
        },
        ...
        {
            L, L, L, L, LRO, WS, L, L, PDF, PDF, PDF, WS, RLO, WS, L, WS, L, L, L, L, WS, L, L, L,
            PDF
        },
        ...
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, EN, EN, EN, CS, EN, EN, AN, CS, WS, R,
            R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, EN, EN, EN, CS, WS, EN, EN, AN, CS,
            WS, R, R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, AN, AN, AN, CS, AN, AN, AN, CS, WS, R,
            R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, AN, AN, AN, CS, WS, AN, AN, AN, CS,
            WS, R, R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, ON, EN, EN, EN, CS, EN, EN, AN, ON,
            CS, WS, R, R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, ON, EN, EN, EN, CS, WS, EN, EN, AN,
            ON, CS, WS, R, R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, ON, AN, AN, AN, CS, AN, AN, AN, ON,
            CS, WS, R, R, ON
        },
        {
            L, L, WS, L, L, L, L, WS, ON, R, R, WS, R, R, WS, ON, AN, AN, AN, CS, WS, AN, AN, AN,
            ON, CS, WS, R, R, ON
        },
        {L, ON, FSI, R, PDI, RLI, R, PDI, LRI, AL, PDI, ON, L},
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, L, LRE, RLI,
            LRE, RLE, LRO, RLO, PDI, PDF, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, L, LRI, L,
            RLE, LRE, RLO, LRO, L, PDI, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, LRI, RLE, LRE, RLO,
            LRO, ON, PDI, L, PDI, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, RLE, ON, LRO, R, LRI, R,
            LRE, RLE, LRO, RLO, R, PDI, R, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, RLE, ON, LRO, R, RLI, ON,
            LRO, RLE, RLO, LRE, ON, PDI, R, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, L, LRE, RLI, LRE, RLE,
            LRO, RLO, PDI, PDF, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, L, LRI, L, RLE, LRE,
            RLO, LRO, L, PDI, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, ON, RLO, LRI, RLE, LRE, RLO, LRO, ON,
            PDI, L, PDI, L, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, RLE, ON, LRO, R, LRI, R, LRE, RLE,
            LRO, RLO, R, PDI, R, PDF, ON
        },
        {
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE,
            LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, LRE, RLE, ON, LRO, R, RLI, ON, LRO, RLE,
            RLO, LRE, ON, PDI, R, PDF, ON
        },
        {LRE, RLE, LRO, RLO, LRI, ON, RLO, L, PDF, ON, PDF, ON, PDI, L},
        {L, WS, LRE, L, L, L, L, L, L, WS, RLO, L, L, R, R, PDF, WS, L, L, PDF, L, L},
        {
            L, WS, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO,
            LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, RLO, L, L, L
        },
        {
            L, WS, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO,
            LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO,
            LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO,
            LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, LRO, RLO, L, L, L
        },
        ...
        {
            R, AL, WS, R, AL, R, AL, WS, ON, L, L, WS, L, L, WS, AN, AN, AN, CS, WS, AN, AN, AN, CS,
            WS, L, L, ON
        },
        {
            R, AL, WS, R, AL, R, AL, WS, ON, L, L, WS, L, L, WS, EN, EN, EN, CS, WS, EN, EN, AN, CS,
            WS, L, L, ON
        },
        {
            R, AL, WS, R, AL, R, AL, WS, ON, L, L, WS, L, L, WS, L, WS, L, L, L, ON, L, ON, WS, AL,
            R, AL, WS, R, AL, R
        },
        {
            R, AL, WS, R, AL, R, AL, WS, ON, L, L, WS, L, L, WS, L, WS, L, L, L, ON, ON, WS, AL, R,
            AL, WS, R, AL, R
        },
        ...
        {
            R, R, R, AL, WS, R, AL, AL, R, WS, R, R, R, AL, R, CS, WS, L, L, L, L, L, L, EN, EN, EN,
            CS, EN, EN, AN
        },
        {R, R, R, R, AL, WS, EN, ON, EN, WS, EN, ON, EN, WS, EN, ES, EN, WS, EN, ET, EN},
        {R, R, R, WS, ET, EN, EN},

        // Test data provided by Laurențiu Iancu
        {R, LRI, RLE, PDI, R},
        {R, LRI, RLE, R, PDI},
        {R, LRI, R, RLE, PDI},
        {R, LRI, RLE, PDI, AL},
    ...
    public static void write(PrintWriter out) throws FileNotFoundException {
        ...
        final Map<String, Set<String>> resultToSource =
                new TreeMap<String, Set<String>>(SHORTEST_FIRST);
        ...
        while (sample.next()) {
            ...
            condensed.clear();
            for (byte paragraphEmbeddingLevel = BIDI_START_LEVEL;
                    paragraphEmbeddingLevel <= 1;
                    ++paragraphEmbeddingLevel) {

                final String reorderedIndexes =
                        reorderedIndexes(TYPELIST, paragraphEmbeddingLevel, linebreaks);
                Integer bitmask = condensed.get(reorderedIndexes);
                if (bitmask == null) {
                    bitmask = 0;
                }
                final int reordered =
                        paragraphEmbeddingLevel == R_DEFAULT ? 3 : paragraphEmbeddingLevel + 1;
                bitmask |= 1 << (reordered);
            ...
            for (final String reorderedIndexes : condensed.keySet()) {
                ...
                addResult(
                        resultToSource,
                        typeString + "; " + Integer.toHexString(bitset).toUpperCase(Locale.ENGLISH),
                        reorderedIndexes);
            }
        }
        /*
    ...
    private static void addResult(
            Map<String, Set<String>> resultToSource,
            final String source,
            final String reorderedIndexes) {
    ...
    private static String reorderedIndexes(
            byte[] types, byte paragraphEmbeddingLevel, int[] linebreaks) {
    ...
    static Comparator<String> SHORTEST_FIRST =
