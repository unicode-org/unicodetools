...
public class YMDDateFormatter implements DateFormatter {
    ...
    /**
     * Creates a new formatter that formats the requested fields. The formatter defaults to the
    ...
    /**
     * Creates a new formatter that formats the requested fields using the provided locale and time
     * zone.
     *
     * @param requestedFields the requested fields
