...
// https://github.com/unicode-org/unicodetools/issues/100
    ...
    public enum Do_Not_Emit_Dispreferred_Type_Values implements Named {
        ...
        private Do_Not_Emit_Dispreferred_Type_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Do_Not_Emit_Dispreferred_Type_Values>(
                Do_Not_Emit_Dispreferred_Type_Values.class, this, shortName, otherNames);
        }
        ...
        private static final NameMatcher<Do_Not_Emit_Dispreferred_Type_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Do_Not_Emit_Dispreferred_Type_Values.class);
    ...
    public enum Do_Not_Emit_Type_Values implements Named {
        ...
        private Do_Not_Emit_Type_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Do_Not_Emit_Type_Values>(
        ...
        private static final NameMatcher<Do_Not_Emit_Type_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Do_Not_Emit_Type_Values.class);
    ...
    public enum IDNA2008_Category_Values implements Named {
        ...
        private IDNA2008_Category_Values(String shortName, String... otherNames) {
            names = new PropertyNames<IDNA2008_Category_Values>(
        ...
        private static final NameMatcher<IDNA2008_Category_Values> NAME_MATCHER = PropertyNames.getNameToEnums(IDNA2008_Category_Values.class);
    ...
    public enum Indic_Conjunct_Break_Values implements Named {
        ...
        private Indic_Conjunct_Break_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Indic_Conjunct_Break_Values>(
        ...
        private static final NameMatcher<Indic_Conjunct_Break_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Indic_Conjunct_Break_Values.class);
    ...
    public enum kEH_Core_Values implements Named {
        ...
        private kEH_Core_Values(String shortName, String... otherNames) {
            names = new PropertyNames<kEH_Core_Values>(
        ...
        private static final NameMatcher<kEH_Core_Values> NAME_MATCHER = PropertyNames.getNameToEnums(kEH_Core_Values.class);
    ...
    public enum Link_Term_Values implements Named {
        ...
        private Link_Term_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Link_Term_Values>(
        ...
        private static final NameMatcher<Link_Term_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Link_Term_Values.class);
    ...
    public enum Math_Class_Values implements Named {
        ...
        private Math_Class_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Math_Class_Values>(
        ...
        private static final NameMatcher<Math_Class_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Math_Class_Values.class);
    ...
    public enum Math_Class_Ex_Values implements Named {
        ...
        private Math_Class_Ex_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Math_Class_Ex_Values>(
        ...
        private static final NameMatcher<Math_Class_Ex_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Math_Class_Ex_Values.class);
    ...
    public enum Other_Joining_Type_Values implements Named {
        ...
        private Other_Joining_Type_Values(String shortName, String... otherNames) {
            names = new PropertyNames<Other_Joining_Type_Values>(
        ...
        private static final NameMatcher<Other_Joining_Type_Values> NAME_MATCHER = PropertyNames.getNameToEnums(Other_Joining_Type_Values.class);
    ...
    public enum RGI_Emoji_Qualification_Values implements Named {
        ...
        private RGI_Emoji_Qualification_Values(String shortName, String... otherNames) {
            names = new PropertyNames<RGI_Emoji_Qualification_Values>(
        ...
        private static final NameMatcher<RGI_Emoji_Qualification_Values> NAME_MATCHER = PropertyNames.getNameToEnums(RGI_Emoji_Qualification_Values.class);
