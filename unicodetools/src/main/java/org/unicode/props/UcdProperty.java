...
public enum UcdProperty {
    ...
    kJURC_NCReading(PropertyType.Miscellaneous, "kJURC_NCReading"),
    kJURC_Numeric(PropertyType.Miscellaneous, "kJURC_Numeric"),
    kJURC_RSUnicode(PropertyType.Miscellaneous, "kJURC_RSUnicode"),
    kJURC_Src(PropertyType.Miscellaneous, "kJURC_Src"),
