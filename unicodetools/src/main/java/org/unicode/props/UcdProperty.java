...
public enum UcdProperty {
    ...
    kJUR_NCReading(PropertyType.Miscellaneous, "kJUR_NCReading"),
    kJUR_Src(PropertyType.Miscellaneous, "kJUR_Src"),
    ...
    kJurchenNumeric(PropertyType.Miscellaneous, "kJurchenNumeric"),
    ...
    kRSJUnicode(PropertyType.Miscellaneous, "kRSJUnicode"),
