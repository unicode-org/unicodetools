...
public class LoadIdnaTest {
    ...
    public static final class TestLine {
        ...
        /**
         * Create a test line from a string. Comments are removed and resulting empty lines are
         * ignored. but it will do \\u and \\x expansion.
         *
         * @param test
         */
            ...
            if (toUnicodeRaw.startsWith("[") && toUnicodeRaw.endsWith("]")) {
                ...
                for (String item :
                        SPACE_SPLITTER.split(
                                toUnicodeRaw.substring(1, toUnicodeRaw.length() - 1))) {
                    try {
    ...
    public static Set<TestLine> load(String directory) {
