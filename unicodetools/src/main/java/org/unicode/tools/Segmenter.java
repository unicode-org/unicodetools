...
public class Segmenter {
    ...
    public static Builder make(UnicodeProperty.Factory propFactory, String type, Target target) {
        String sourceFileName = target == Target.FOR_CLDR ? "SegmenterCldr.txt" : "SegmenterDefault.txt";
        ...
        if (data == null) {
            ...
            for (String line : FileUtilities.in(Segmenter.class, sourceFileName)) {
                ...
                if (key == null) {
                    throw new IllegalArgumentException("Missing @ type in rule syntax, " + sourceFileName + " line=" + lineCount);
                }
                data.put(key, line);
            }
        ...
        if (lines == null) {
            throw new IllegalArgumentException("Missing type=" + type + " in file " + sourceFileName);
        }
    ...
    public static class Builder {
        ...
        private class MyXSymbolTable extends UnicodeSet.XSymbolTable {
            public boolean applyPropertyAlias(String propertyName, String propertyValue, UnicodeSet result) {
                ...
                if (x.isEmpty()) {
                    ...
                    System.out.println(
                            "Segmenter.MyXSymbolTable: !Empty! " + propertyName + "=" + propertyValue);
                }
        ...
        public boolean addLine(String line) {
            ...
            if (relationPosition < 0) {
                relationPosition = line.indexOf('\u00D7');
                if (relationPosition < 0) {
                    throw new IllegalArgumentException("Couldn't find =, \u00F7, or \u00D7 on line: " + line);
                }
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (PrintWriter out = FileUtilities.openUTF8Writer(Settings.Output.GEN_DIR + "cldr/segmentation/", "rootAddon.xml")) {
            ...
            for (final String type : new String[] {"GraphemeClusterBreak", "LineBreak", "SentenceBreak", "WordBreak"}) {
                ...
                if (type.equals("")) {
                    out.print("\t\t\t<suppressions type=\"standard\">\n"
