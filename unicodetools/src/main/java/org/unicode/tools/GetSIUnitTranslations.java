...
public static void main(String[] args) {
    ...
    for (String locale : "af sq am ar hy as az eu be bn bs bg my ca zh-HK zh-CN zh-TW hr cs da nl en-GB et fa fil fi fr fr-CA gl ka de el gu iw hi hu is id it ja kn kk km ko ky lo lv lt mk ms ml mr mn ne no or pl pt-BR pt-PT pa ro ru sr si sk sl es es-419 sw sv ta te th tr uk ur uz vi zu rm".split(" ")) {
        String cldrLocale = LanguageCodeConverter.GOOGLE_CLDR.getOrDefault(locale, locale.replace('-', '_'));
        //System.out.println("# " + cldrLocale + "\t" + locale);
        CLDRFile cldrFile = factory.make(cldrLocale, true);
        M3<String, String, String> cm = ChainedMap.of(new TreeMap(), new TreeMap(), String.class);
