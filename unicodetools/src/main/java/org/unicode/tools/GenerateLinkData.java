            ...
            SimpleFormatter.compile(
                    HEADER_BASE
                            + JOIN_N_HASH.join(
                                    ...
                                    "",
                                    "The fully-escaped field percent-escapes code points based on https://url.spec.whatwg.org/#percent-encoded-bytes.",
                                    "These are all the literal syntax characters in each Part and all code points above ASCII.",
