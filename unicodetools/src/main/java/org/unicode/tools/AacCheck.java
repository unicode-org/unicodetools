...
public class AacCheck {
                ...
                if (range.codepoint == range.codepointEnd) {
                    ...
                    System.out.println(
                            Utility.hex(range.codepoint)
                                    ...
                                    + UCharacter.getName(range.codepoint)
                                    + ".."
                                    + UCharacter.getName(range.codepointEnd));
                }
            }
            for (String cps : ALLOWED.strings()) {
                System.out.println(Utility.hex(cps) + " ; " + EmojiData.EMOJI_DATA.getName(cps));
            }
        } else {
    ...
    private static final UnicodeSet EMOJI_VARIATION_SELECTORS =
            new UnicodeSet("[\uFE0F\uFE0E]").freeze();
