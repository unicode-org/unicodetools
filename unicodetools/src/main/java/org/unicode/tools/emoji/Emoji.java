...
public class Emoji {
  ...
  // static final boolean EMOJI_BUILD_VERSION =
  // CldrUtility.getProperty("emoji-version", false);

  /**
   * Change the following according to whether we are generating the beta
   * version of files, or the new version. We support generating the last
   * version in order to make improvements to the charts.
   */
  public static final boolean IS_BETA =
      CldrUtility.getProperty("emoji-beta", false);
  public static final boolean BETA_IS_OPEN =
      CldrUtility.getProperty("emoji-beta-open", false);

  /**
   * Set the following to true iff the charts for the release should still point
   * to proposed.html for TR51. The main function is to add pointers between the
   * release and beta charts. Also change the VERSION_LAST_RELEASED2, etc
   * below!!!
   */
  public static final boolean USE_PROPOSED =
      true; // set to true between the release of Emoji 5.0 & Unicode 10.0. (or
            // similar situation)
  ...
  /**
   * Change each following once we release. That is, VERSION_LAST_RELEASED*
   * becomes VERSION_BETA*, and both the latter increment. Also add to
  ...
  public static final VersionInfo VERSION_TO_TEST_PREVIOUS =
      VERSION_LAST_RELEASED;
  ...
  public final static Map<VersionInfo, String> EMOJI_TO_DATE =
  ...
  private static final String BETA_COLORED =
      "<span style='color:red'>" + BETA_PLAIN + "</span>";

  // public static final VersionInfo VERSION_FORMAT1 =
  // VersionInfo.getInstance(1);
  ...
  public static final String BETA_HEADER_AFFIX =
      Emoji.IS_BETA ? BETA_COLORED : "";

  public static final String VERSION_LAST_RELEASED_STRING =
      VERSION_LAST_RELEASED.getVersionString(2, 4);
  public static final String VERSION_BETA_STRING =
      VERSION_BETA.getVersionString(2, 4);
  public static final String VERSION_BETA_STRING_WITH_COLOR =
      VERSION_BETA_STRING + BETA_COLORED;
  ...
  public static final String VERSION_STRING =
      VERSION_TO_GENERATE.getVersionString(2, 4);

  public static final VersionInfo VERSION_TO_GENERATE_UNICODE =
      IS_BETA ? VERSION_BETA_UNICODE : VERSION_LAST_RELEASED_UNICODE;

  // public static final String TR51_SVN_DIR = Settings.UNICODE_DRAFT_DIRECTORY
  // + "reports/tr51/"; public static final String TR51_PREFIX = IS_BETA ?
  // "internal-beta/" : "internal/";

  public static final String EMOJI_DIR =
      Settings.Output.GEN_DIR + "emoji/" + (Emoji.ABBR ? "🏴" : "");
  public static final String CHARTS_DIR =
      EMOJI_DIR + "charts-" + VERSION_STRING + "/";
  ...
  public static final String DATA_DIR_PRODUCTION_BASE =
      "https://unicode.org/Public/emoji/";
  public static final String DATA_DIR_PRODUCTION =
      DATA_DIR_PRODUCTION_BASE + VERSION_STRING + "/";

  public static final String IMAGES_SOURCE_DIR_SVG =
      Settings.UnicodeTools.DATA_DIR + "images/";
  // TODO: This should be relative to GEN_DIR, not using "../../" to maybe get
  ...
  static final UnicodeSet PROFESSION_OBJECT =
      new UnicodeSet(
          "[⚕🌾🍳🎓🎤🏫🏭💻💼🔧🔬🎨 🚒 ✈ 🚀 ⚖ \\U0001F37C \\U0001F9AF \\U0001F9BC \\U0001F9BD]")
          .freeze();
  static final UnicodeSet HAIR_STYLES =
      new UnicodeSet("[\\U0001F9B0-\\U0001F9B3]").freeze();
  static final UnicodeSet HAIR_EXPLICIT =
  ...
  static final UnicodeMap<String> MALE_TO_OTHER =
      new UnicodeMap<String>()
          .put(UTF16.valueOf(0x2642),
               UTF16.valueOf(0x2640)) // MALE SIGN→FEMALE SIGN
          .put(UTF16.valueOf(0x1F466), UTF16.valueOf(0x1F467)) // boy→girl
          .put(UTF16.valueOf(0x1F468), UTF16.valueOf(0x1F469)) // man→woman
          .put(UTF16.valueOf(0x1F474),
               UTF16.valueOf(0x1F475)) // old man→old woman
          .put(UTF16.valueOf(0x1F385),
               UTF16.valueOf(0x1F936)) // Santa Claus→Mrs. Claus
          .put(UTF16.valueOf(0x1F934),
               UTF16.valueOf(0x1F478)) // prince→princess
          .put(UTF16.valueOf(0x1F57A),
               UTF16.valueOf(0x1F483)) // man dancing→woman dancing
          //            .put(UTF16.valueOf(0x1F46C), UTF16.valueOf(0x1F46B)) //
          //            two men holding hands→man and woman holding hands
          //            .put(UTF16.valueOf(0x1F46C), UTF16.valueOf(0x1F46D)) //
          //            two men holding hands→two women holding hands
          //            .put(UTF16.valueOf(0x1F935), "") // man in tuxedo→<NONE>
          //            .put(UTF16.valueOf(0x1F574), "") // man in suit
          //            levitating→<NONE> .put(UTF16.valueOf(0x1F472), "") //
          //            man with Chinese cap→<NONE> .put(UTF16.valueOf(0x1F9D4),
          //            "") // BEARDED PERSON→<NONE>
          .freeze();
  static final UnicodeMap<String> FEMALE_TO_OTHER =
      new UnicodeMap<String>()
          .put(UTF16.valueOf(0x2640),
               UTF16.valueOf(0x2642)) // FEMALE SIGN→MALE SIGN
          .put(UTF16.valueOf(0x1F467), UTF16.valueOf(0x1F466)) // girl→boy
          .put(UTF16.valueOf(0x1F469), UTF16.valueOf(0x1F468)) // woman→man
          .put(UTF16.valueOf(0x1F475),
               UTF16.valueOf(0x1F474)) // old woman→old man
          .put(UTF16.valueOf(0x1F936),
               UTF16.valueOf(0x1F385)) // Mrs. Claus→Santa Claus
          .put(UTF16.valueOf(0x1F478),
               UTF16.valueOf(0x1F934)) // princess→prince
          .put(UTF16.valueOf(0x1F483),
               UTF16.valueOf(0x1F57A)) // woman dancing→man dancing
          //            .put(UTF16.valueOf(0x1F46D), UTF16.valueOf(0x1F46C)) //
          //            two women holding hands→two men holding hands
          //            .put(UTF16.valueOf(0x1F46D), UTF16.valueOf(0x1F46B)) //
          //            two women holding hands→man and woman holding hands
          //            .put(UTF16.valueOf(0x1F470), "") // bride with
          //            veil→<NONE> .put(UTF16.valueOf(0x1F930), "") // pregnant
          //            woman→<NONE> .put(UTF16.valueOf(0x1F931), "") //
          //            breast-feeding→<NONE> .put(UTF16.valueOf(0x1F9D5), "")
          //            // woman with headscarf→<NONE>
          .freeze();
  ...
  public enum Source {
    ...
    @Deprecated fbm("FBM", "Messenger (Facebook)"),
    samsung("Sams"),
    emojixpress,
    ref,
    emojination,
    ...
    static final Set<Source> OLD_SOURCES = ImmutableSet.copyOf(EnumSet.of(
        gmail, sb, dcm, kddi)); // do this to get same order as Source
    static final Set<Source> VENDOR_SOURCES = ImmutableSet.copyOf(
        EnumSet.of(apple, google, twitter, emojione, samsung, fb,
                   windows)); // do this to get same order as Source
    static final Set<Emoji.Source> platformsToIncludeNormal =
        ImmutableSet.copyOf(
            EnumSet.of(Source.apple, Source.google, Source.windows,
                       Source.twitter, Source.emojione, Source.samsung,
    ...
    static final Set<Emoji.Source> PLATFORM_FALLBACK =
        ImmutableSet.<Emoji.Source>builder()
            .addAll(EnumSet.of(Source.apple, Source.google, Source.windows,
                               Source.twitter, Source.emojione, Source.samsung,
                               Source.fb))
    ...
    private Source() { this(null, null); }
    private Source(String shortName) { this(shortName, null); }
    private Source(String shortName, String longName) {
      this.shortName =
          shortName != null ? shortName : UCharacter.toTitleCase(name(), null);
      this.longName =
          longName != null ? longName : UCharacter.toTitleCase(name(), null);
    }

    boolean isGif() { return compareTo(Source.gmail) >= 0; }
    ...
    public String getPrefix() { return this == google ? "android" : name(); }
    ...
    public String getImageDirectory() {
      return this == svg ? Emoji.IMAGES_SOURCE_DIR_SVG
  ...
  public enum CharSource {
    ...
    private CharSource(String shortString, String letter, String proposals) {
      ...
      this.letter = letter;
      this.proposals =
          ImmutableSet.copyOf(SPLITTER_COMMA.splitToList(proposals));
    }
  }
  ...
  public static final UnicodeSet TAGS =
      new UnicodeSet(TAG_BASE, TAG_TERM_CHAR).freeze();
  ...
  static final UnicodeSet LATIN1_LETTER =
      new UnicodeSet("[[:L:]&[\\x{0}-\\x{FF}}]]").freeze();
  ...
  public static String getHexFromFlagCode(String isoCountries) {
    String cc = new StringBuilder()
                    .appendCodePoint(isoCountries.charAt(0) +
                                     Emoji.FIRST_REGIONAL - 'A')
                    .appendCodePoint(isoCountries.charAt(1) +
                                     Emoji.FIRST_REGIONAL - 'A')
                    .toString();
    return cc;
  }
  ...
  static String getRegionCodeFromEmoji(String chars) {
    ...
    return new StringBuilder()
        ...
        .appendCodePoint(chars.codePointAt(Character.charCount(first)) -
                         FIRST_REGIONAL + 'A')
        .toString();
  }
  ...
  public static final UnicodeSet MAN_OR_WOMAN_OR_ADULT = new UnicodeSet()
                                                             .add(Emoji.WOMAN)
                                                             .add(Emoji.MAN)
                                                             .add(Emoji.ADULT)
                                                             .freeze();
  ...
  public static final UnicodeSet EXCLUDED_FOR_SEGMENTATION =
      new UnicodeSet("[#*0-9©®™〰〽🇦-🇿]");
  ...
  //    static final UnicodeSet EMOJI_CHARS_WITHOUT_FLAGS = new
  //    UnicodeSet(EMOJI_CHARS).freeze(); static {
  ...
  //            config.getEnglish().getName("territory", s));
  ...
  public static boolean isRegionalIndicator(int firstCodepoint) {
    return FIRST_REGIONAL <= firstCodepoint &&
        firstCodepoint <= Emoji.LAST_REGIONAL;
  }
  ...
  public static final UnicodeSet ASCII_LETTERS =
      new UnicodeSet("[A-Za-z]").freeze();
  public static final String EMOJI_VARIANT_STRING =
      String.valueOf(EMOJI_VARIANT);
  ...
  public static String getLabelFromLine(Output<Set<String>> newLabel,
                                        String original) {
    String line = original.replace(EMOJI_VARIANT_STRING, "")
                      .replace(TEXT_VARIANT_STRING, "")
                      .trim();
    if (line.isEmpty()) {
      return line;
    }
    ...
    //        if (tabPos < 0 &&
    //        Emoji.EMOJI_CHARS.contains(getEmojiSequence(line, 0))) {
    //            tabPos = line.length();
    //
    //        }
  ...
  //    private static final Transform<String,String> WINDOWS_URL = new
  ...
  public static String getEmojiSequence(String line, int i) {
    ...
    if (secondCodepoint == ENCLOSING_KEYCAP ||
        (isRegionalIndicator(firstCodepoint) &&
         isRegionalIndicator(secondCodepoint))) {
  ...
  static final UnicodeSet U90 =
      new UnicodeSet(
          ...
          .freeze();
  public static final Transliterator UNESCAPE =
      Transliterator.getInstance("hex-any/Perl");

  static String getImageFilenameFromChars(Emoji.Source type, String chars) {
    chars = chars.replace(Emoji.EMOJI_VARIANT_STRING, "");
    //        if (type == Emoji.Source.android &&
    //        Emoji.SKIP_ANDROID.contains(chars)) { // hack to exclude certain
    //        android
    //            return null;
    //        }
    if (type == Source.charOverride) {
      ...
      if (overrideSource != null) {
        type = overrideSource;
      } else if (CountEmoji.ZwjType.getType(chars) !=
                 CountEmoji.ZwjType.family) {
  ...
  static String getFlagCode(String chars) {
    ...
    int firstLen = Character.charCount(firstCodepoint);
    int secondCodepoint =
        firstLen >= chars.length() ? 0 : chars.codePointAt(firstLen);
  ...
  static final transient Collection<Age_Values> output =
  ...
  static final <T, C extends Collection<T>>
      C getValues(String source, UnicodeMap<T> data, C output) {
    output.clear();
  ...
  public static String toUHex(String s) { return "U+" + Utility.hex(s, " U+"); }
  ...
  //        EMOJI_SINGLETONS.toPattern(false)); System.out.println("Without
  ...
  public static final String TR51_HTML_BETA =
      "../../reports/tr51/proposed.html";
  public static final String TR51_HTML =
      IS_BETA || USE_PROPOSED ? TR51_HTML_BETA
                              : "https://unicode.org/reports/tr51/tr51.html";
  ...
  static {
    for (String line : FileUtilities.in(GenerateEmoji.class, "dings.txt")) {
      ...
      DING_MAP.put(Integer.parseInt(parts[0], 16),
                   Integer.parseInt(parts[1], 16));
    }
    DING_MAP.freeze();
  }

  static final UnicodeMap<String> WHITESPACE =
      Emoji.LATEST.load(UcdProperty.White_Space);
  ...
  private static void checkDuplicates(UnicodeMap<String> dcmProp,
                                      UnicodeMap<String> kddiProp,
                                      UnicodeMap<String> sbProp) {
    Relation<String, String> carrierToUnicode =
        Relation.of(new TreeMap(), TreeSet.class);
    for (Entry<String, String> unicodeToCarrier : dcmProp.entrySet()) {
      carrierToUnicode.put(unicodeToCarrier.getValue(),
                           unicodeToCarrier.getKey());
    }
    ...
    int count = 0;
    for (Entry<String, Set<String>> carrierAndUnicodes :
         carrierToUnicode.keyValuesSet()) {
      ...
      if (unicodes.size() > 1) {
        ...
        for (String s : unicodes) {
          if (DEBUG)
            System.out.println(carrierAndUnicodes.getKey() + "\tU+" +
                               Utility.hex(s, " U+") + "\t" +
