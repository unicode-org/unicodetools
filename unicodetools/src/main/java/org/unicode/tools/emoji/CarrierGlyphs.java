...
public class CarrierGlyphs {
    ...
    private static final Comparator SB_FIRST =
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter out =
                FileUtilities.openUTF8Writer(
                        Settings.UnicodeTools.UNICODETOOLS_REPO_DIR + "/reports/tr51/",
                        "carrier-emoji.html");
        out.println(
                "<html>\n"
                        + "<head>\n"
        ...
        for (String s : carrier) {
            ...
            out.println(
                    "<tr><td>"
                            ...
                            + "</td>"
                            + "\n\t<td>"
                            + replaceNull(kddiCode, "n/a")
                            + "</td>"
                            + "\n\t<td>"
                            + img("kddi", s, kddiCode)
                            + "</td>"
                            + "\n\t<td>"
                            + replaceNull(dcmCode, "n/a")
                            + "</td>"
                            + "\n\t<td>"
                            + img("dcm", s, dcmCode)
                            + "</td>"
                            + "\n\t<td>"
                            + replaceNull(sbCode, "n/a")
                            + "</td>"
                            + "\n\t<td>"
                            + img("sb", s, sbCode)
                            + "</td>"
    ...
    public static String img(String type, final String unicode, String code) {
        ...
        final String filename =
                "images/"
                        ...
                        + type
                        + "_"
                        + Utility.hex(unicode, "_").toLowerCase(Locale.ROOT)
                        + ".gif";
        return // !new File(dir, filename).exists() ? "missing" :
        "<img class='imgb' src='" + filename + "'>";
    }

    static final Transform<String, String> AU_URL =
            new Transform<String, String>() {
                public String transform(String s) {
                    ...
                    return "http://trialgoods.com/images/200807au/" + transformed + ".gif";
                }
            };
    static final Transform<String, String> DCM_URL =
            new Transform<String, String>() {
                public String transform(String s) {
                    ...
                    return "http://trialgoods.com/images/200807i/" + transformed + ".gif";
                }
            };
    // http://trialgoods.com/images/200807sb/F72.gif
    static final Transform<String, String> SB_URL =
            new Transform<String, String>() {
                public String transform(String s) {
                    // if (true) return null;
                    ...
                    return "http://trialgoods.com/images/200807sb/" + transformed + ".gif";
                }
            };
