...
public class EmojiRename {
    ...
    static final File DIR = new File(Settings.Output.GEN_DIR + "emoji_images_source");
    ...
    private static void renameCountryFlags(
            Transform<String, String> transform, String... subdirectories) {
    ...
    private static final Transform<String, String> TWITTER_TRANSFORM =
    ...
    private static final Transform<String, String> WINDOWS_TRANSFORM =
            new Transform<String, String>() {
    ...
    private static final Transform<String, String> ANDROID_TRANSFORM =
            new Transform<String, String>() {
                @Override
                public String transform(String prefix) {
                    String emoji = null;
                    if (prefix.length() == 2) {
                        ...
                        if (prefix.startsWith("emoji_u")) {
                            StringBuilder b = new StringBuilder();
                            for (String hexes :
                                    UNDERBAR.split(prefix.substring("emoji_u".length()))) {
                                b.appendCodePoint(Integer.parseInt(hexes, 16));
                            }
                            emoji = b.toString();
                        }
