...
public class GmailEmoji {
    static final IndexUnicodeProperties LATEST =
            IndexUnicodeProperties.make(Emoji.VERSION_BETA_UNICODE);
    ...
    static class Data implements Comparable<Data> {
        ...
        static final UnicodeMap<String> OVERRIDES =
                new UnicodeMap<String>()
                        ...
                        .putAll(
                                new UnicodeSet(
                                        "[\\U000FE4C5\\U000FE82D\\U000FE83C\\U000FEB89\\U000FEE10-\\U000FEE1B"
                                                + "\\U000FEE1D-\\U000FEE25\\U000FEE2D-\\U000FEE30\\U000FEE40-\\U000FEE4A"
                                                + "\\U000FEE70-\\U000FEE7D\\U000FEEA0]"),
                                BOGUS);
        ...
        public Data(List<String> list) {
            ...
            if (override != null) {
                ...
                unicodeTemp =
                        new StringBuilder()
                                .appendCodePoint(Integer.parseInt(list.get(22), 16))
                                .toString();
            } else {
        ...
        public String getCarrier(
                List<String> list, int item, String unicodeTemp, UnicodeMap<String> unicodeMap) {
        ...
        public String toHtml() {
            ...
            return new StringBuilder("<tr><td>")
                    .append("<img src='" + URL_PREFIX + url2 + "'>")
                    .append("</td><td>")
                    // .append(data.unicode)
                    ...
                    .append("</td><td>")
                    .append(
                            uName == null || unicode.equals(BOGUS)
                                    ? "n/a"
                                    : name.equals(uName) ? "" : uName)
                    .append("</td></tr>")
                    .toString();
        }
    }
    ...
    static {
        ...
        Data crab = null;
        for (String line :
                FileUtilities.in(Settings.Output.GEN_DIR + "/emoji_images", "gmail_emoji.txt")) {
            if (line.startsWith("#")) continue;
            List<String> list = semi.splitToList(line);
            Data data = new Data(list);
            Data oldData = unicode2data.get(data.unicode);
            if (oldData != null
                    && !data.unicode.equals(Data.UNKNOWN)
                    && !data.unicode.equals(Data.BOGUS)) {
    ...
    public static String getURL(String string) {
        ...
        return data == null || data.unicode.equals(Data.BOGUS) || data.unicode.equals(Data.UNKNOWN)
                ? null
