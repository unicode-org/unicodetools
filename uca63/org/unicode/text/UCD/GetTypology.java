...
public class GetTypology {
  public static void main(String[] args) throws IOException {
    ...
    BufferedReader br = BagFormatter.openUTF8Reader(Utility.UCD_DIRECTORY, filename);
    ...
    PrintWriter out = BagFormatter.openUTF8Writer(Utility.GENERATED_DIRECTORY + "/classification", "classification_analysis.txt");
