...
public final class MappingsForFractionalUCA {
    ...
    /* package */ static class MappingWithSortKey implements Comparable<MappingWithSortKey> {
        ...
        private MappingWithSortKey(UCA uca, String prefix, String s, CEList ces) {
            this(prefix, s, ces, uca.getSortKey(ces, UCA.NON_IGNORABLE, AppendToCe.none));
        }
    ...
    /* package */ SortedSet<MappingWithSortKey> getMappings() {
        SortedSet<MappingWithSortKey> ordered = getSortedUCAMappings();
    ...
    private SortedSet<MappingWithSortKey> getSortedUCAMappings() {
        ...
        SortedSet<MappingWithSortKey> ordered = new TreeSet<MappingWithSortKey>();
    ...
    private void modifyMappings(SortedSet<MappingWithSortKey> ordered) {
        ...
        int lMiddleDotSec;
        {
            CEList lMiddleDotCEs = uca.getCEList("\u0140", true);
        ...
        List<MappingWithSortKey> newMappings = new LinkedList<MappingWithSortKey>();
        Iterator<MappingWithSortKey> it = ordered.iterator();
        while (it.hasNext()) {
