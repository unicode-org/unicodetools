...
1.  Setup
    *   Make sure Settings.latestVersion is set right. (If you've already done
...
2.  Run GenerateIdna.java
    ...
    *   Diff with the previous version, and make sure everything is understood,
        ...
        ```
        Generated$ meld ../src/unicodetools/data/idna/dev/IdnaMappingTable.txt idna/18.0.0/IdnaMappingTable.txt
        Generated$ cp idna/18.0.0/IdnaMappingTable.txt ../src/unicodetools/data/idna/dev/IdnaMappingTable.txt
        ```
...
3.  Now run GenerateIdnaTest.java, in order to generate the test file.
    ...
    2.  Diff with the previous version, and make sure everything is understood,
        then copy back into the dev folder.
        ```
        Generated$ meld ../src/unicodetools/data/idna/dev/IdnaTestV2.txt idna/18.0.0/IdnaTestV2.txt
        Generated$ cp idna/18.0.0/IdnaTestV2.txt ../src/unicodetools/data/idna/dev/IdnaTestV2.txt
        ```
