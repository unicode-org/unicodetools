...
public final class SecTerToFractional {
    ...
    public String toString() {
        ...
        if (ss2f != null) {
            for (Map.Entry<Integer, SecondaryToFractional> entry : ss2f.entrySet()) {
                SecondaryToFractional s2f = entry.getValue();
    ...
    public void assignFractionalWeights() {
        ...
        if (ss2f != null) {
            ...
            for (SecondaryToFractional s2f : ss2f.values()) {
    ...
    public int getFractionalSecAndTer(int sec, int ter) {
        ...
        if (sec == 0) {
            ...
            SecondaryToFractional s2f = ss2f.get(sec);
