...
public class WriteCollationData implements UCD_Types, UCA_Types {
    ...
    //static final String DIR31 = "c:\\Documents and Settings\\Davis\\My Documents\\UnicodeData\\Update 3.1/";
 ...
 => U+00DC LATIN CAPITAL LETTER U WITH DIAERESIS, U+0304 COMBINING MACRON
    ...
    static void writeRules (byte option, boolean shortPrint, boolean noCE) throws IOException {
        ...
        while (true) {
            ...
            log2.println(s + "\t" + bidiBracket(CEList.toString(ces, len)) + "\t" + ucd.getCodeAndName(s));
...
2F800..2FA1F; CJK Compatibility Ideographs Supplement
        ...
        long variableTop = collator.getVariableHigh() & FractionalUCA.Variables.INT_MASK;
...
A4C6;YI RADICAL KE;So;0;ON;;;;;N;;;;;
    ...
    static final int[] extraConformanceTests = {
        ...
        FractionalUCA.Variables.IMPLICIT_4BYTE_BOUNDARY, FractionalUCA.Variables.IMPLICIT_4BYTE_BOUNDARY-1, FractionalUCA.Variables.IMPLICIT_4BYTE_BOUNDARY+1,
    };
