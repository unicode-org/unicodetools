...
public class GenerateUnihanCollatorFiles {
    ...
    static final String OUTPUT_DIRECTORY = Utility.WORKSPACE_DIRECTORY + "cldr-tmp/dropbox/han";
    static final String OUTPUT_DIRECTORY_REPLACE = Utility.WORKSPACE_DIRECTORY + "cldr-tmp/dropbox/han/replace";
