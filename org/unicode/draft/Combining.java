...
public class Combining {
  ...
  private void run() throws IOException {
    ...
    TablePrinter indexTable = new TablePrinter()
    ...
    .addColumn("Chars")
    ;
    TablePrinter summaryTable = new TablePrinter()
    ...
    for (String language : CharacterFrequency.getLanguagesWithCounter()) {
      ...
      String englishLocaleName = ULocale.getDisplayName(language, "en");
    ...
    CompressedDataOutput out = new CompressedDataOutput().set(dataOutputStream);
      ...
      ;
      long enough = (long)(total*0.99999d);
  ...
  private void printIndex(TablePrinter indexTable, String file) throws IOException {
    PrintWriter index = BagFormatter.openUTF8Writer(Utility.GEN_DIR + "/frequency-html", file);
  ...
  private static class CharacterSamples {
    ...
    CharacterSamples(String language) {
      ...
      RuleBasedCollator spaceComp = (RuleBasedCollator) Collator.getInstance(new ULocale(language));
