...
public class CharacterFrequency {
	private static final String DATA_DIR = "/Users/markdavis/Documents/indigo/DATA/frequency/languages/";
	private static final String DATA_DIR_RANK = "/Users/markdavis/Documents/indigo/DATA/frequency/languages-rank/";
...
//	}
	...
	public static Counter<Integer> getCodePointCounter(String language, boolean ranked) {
		...
		if (result == null) {
			...
			SemiFileReader handler = new SequenceHandler(result).process(ranked ? DATA_DIR_RANK : DATA_DIR, language + ".txt");
...
//			}
			...
			int cp = Integer.parseInt(items[0],16);
