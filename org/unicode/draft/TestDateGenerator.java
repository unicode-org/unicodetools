...
public class TestDateGenerator {
  ...
  public static void main(String[] args) {
    ...
    for (ULocale locale : new ULocale[]{ULocale.KOREAN, ULocale.CHINESE, ULocale.TRADITIONAL_CHINESE, ULocale.JAPANESE}) {
  ...
  private static void test(String test, ULocale locale) {
    DateTimePatternGenerator foo = DateTimePatternGenerator.getInstance(locale);
    String pattern = foo.getBestPattern(test);
    DateFormat df = DateFormat.getPatternInstance(test, locale);
