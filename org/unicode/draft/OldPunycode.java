 ...
 * @draft
 */
final public class OldPunycode {
  static boolean  showProgress = false;
    ...
    public static StringBuffer encode(StringBuffer src, boolean[] caseFlags) throws StringPrepParseException{
      if (showProgress) {
        ...
        int[] cpBuffer = new int[src.length()];
        ...
        for(handledCPCount=basicLength; handledCPCount<srcCPCount; /* no op */) {
          if (showProgress) {
            ...
            if (showProgress) System.out.println("Next larger: " + Integer.toString(m, 16));
            ...
            if (showProgress) System.out.println("\tStart Delta: " + Integer.toString(delta, 16));
            int startWriting = 0;
            ...
            if (showProgress) System.out.println("\tChars: " + String.valueOf(dest, startWriting, destLength));
