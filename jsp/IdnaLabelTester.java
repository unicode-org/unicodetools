...
public class IdnaLabelTester {
  ...
  public static String NFKC_CaseFold(int i, Normalizer.Mode mode, boolean onlyLower, boolean keepDI) {
...
//    
//
//    Map<String,UnicodeSet> mapNFKC_CF_RDI = new TreeMap(new MultiComparator(new Comparator[] {ordering, CODEPOINT_ORDER});
